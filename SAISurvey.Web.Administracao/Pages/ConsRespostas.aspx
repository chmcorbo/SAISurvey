<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsRespostas.aspx.cs" Inherits="SAISurvey.Web.Administracao.Pages.ConsRespostas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Pesquisar respostas</h2>
    <table class="style1">
        <tr>
            <td>
                Descrição</td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID" 
                    DataNavigateUrlFormatString="~/Pages/CadastroResposta.aspx?id={0}" 
                    HeaderText="Operação 1" Text="Editar" />
                <asp:HyperLinkField DataNavigateUrlFields="id" 
                    DataNavigateUrlFormatString="~/Pages/ExcluirResposta.aspx?id={0}" 
